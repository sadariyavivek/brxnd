...
final class RouterImp: NSObject, Router {
	...
	func present(_ module: UIPresentable?, animated: Bool, embedInNavController: Bool) {
		let embeddedView = UINavigationController(rootViewController: module as! UIViewController)
		rootController?.present(embeddedView, animated: animated, completion: nil)
	}
